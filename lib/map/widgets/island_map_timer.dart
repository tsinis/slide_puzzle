...
/// {@template island_map_timer}
/// Displays how many seconds elapsed since starting the puzzle.
/// {@endtemplate}
class IslandMapTimer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ResponsiveLayoutBuilder(
      ...
      child: (currentSize) {
        ...
        return Row(
          key: const Key('island_map_timer'),
          ...
          children: [
            ...
            FaIcon(
              ...
              key: const Key('island_map_timer_icon'),
              color: Colors.white,
  ...
  String _getDurationLabel(Duration duration, BuildContext context) =>
      context.l10n.islandMapPuzzleDurationLabelText(
