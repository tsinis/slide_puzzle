...
class TimerBloc extends Bloc<TimerEvent, TimerState> {
  ...
  void _onTimerStarted(TimerStarted _, Emitter<TimerState> emit) {
    _tickerSubscription?.cancel();
  ...
  void _onTimerStopped(TimerStopped _, Emitter<TimerState> emit) {
    _tickerSubscription?.pause();
    emit(state.copyWith(isRunning: false));
  }

  void _onTimerReset(TimerReset _, Emitter<TimerState> emit) {
    _tickerSubscription?.cancel();
