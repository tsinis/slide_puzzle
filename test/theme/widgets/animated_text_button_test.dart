...
void main() {
  group('AnimatedTextButton', () {
    ...
    testWidgets('onEnd is called', (tester) async {
      var called = 0;
      void onEnd() => called++;
    ...
    testWidgets('style is animated over time', (tester) async {
      await tester.pumpApp(
        Directionality(
          textDirection: TextDirection.ltr,
          child: Material(
...
class TestAnimatedTextButton extends StatefulWidget {
  ...
  const TestAnimatedTextButton({required this.switchKey, this.onEnd, Key? key})
      : super(key: key);
