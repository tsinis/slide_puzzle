...
void main() {
  group('IslandMapTimer', () {
    ...
    testWidgets('renders on a medium display', (tester) async {
      ...
      expect(
        find.byKey(Key('island_map_timer')),
        findsOneWidget,
      );
    });
    ...
    testWidgets(
      ...
      'when secondsElapsed is less than a minute',
      (tester) async {
    ...
    testWidgets(
      'renders secondsElapsed from TimerBloc '
      'when secondsElapsed is more than a minute',
      (tester) async {
    ...
    testWidgets(
      'renders secondsElapsed from TimerBloc '
      'when secondsElapsed is more than an hour',
      (tester) async {
    ...
    testWidgets(
      ...
      'based on secondsElapsed from TimerBloc',
      (tester) async {
        const secondsElapsed = 5450;
        when(() => timerBloc.state)
            .thenReturn(TimerState(secondsElapsed: secondsElapsed));
    ...
    testWidgets('renders timer icon', (tester) async {
      ...
      expect(
        find.byKey(Key('island_map_timer_icon')),
        findsOneWidget,
      );
    });
  });
